...
void run() {
    ...
    test({"--file=test"});
    test({"--file=test", "-f"});
    test({"--file=test", "-f", "test2"});
    test({"--file=test", "--file"});
    test({"--file=test", "--file="});
    test({"--file=test", "--file=test2"});
    test({"--file=test", "--file=test2", "-o"});
    test({"--file=test", "--file=test2", "--out="});
    test({"--file=test", "--file=test2", "--out=test3"});
    test({"--file=test", "--file=test2", "--out=test3", "--out=test4"});
    test({"--file=test", "--file=test2", "--out=test3", "mies"});
    test({"-x"});
    test({"-f", "test", "noot", "-f", "test", "-x"});
}